         ...
         Container(
          ...
          children: [
            ...
            Text(
              ...
              style: AppTextStyles.montserratMedum16.copyWith(color: ColorsLight.prussianBlue)
            ),
            IconButton(
          ...
          children: weekDays.map((d) {
            return Expanded(
              child: Center(
                child: Text(
                  d,
                  style:AppTextStyles.montserratRegular14.copyWith(fontSize: 12,color: ColorsLight.royalBlue)
                ),
              ),
            );
          }).toList(),
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    "$day",
                    style: AppTextStyles.montserratRegular14.copyWith(color:isAvailable?ColorsLight.darkGrey: ColorsLight.blueGray,fontSize: 12)
                  ),
                ),
              );
            },
